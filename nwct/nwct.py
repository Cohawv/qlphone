...
def update():
    ...
    try:
        r1 = requests.get("https://gitee.com/lstcml/qinglongscripts/raw/master/nwct/nwct.py").text
        ...
        if float(r2) > version:
            ...
            os.system("ql raw https://gitee.com/lstcml/qinglongscripts/raw/master/nwct/nwct.py &")
    except:
        pass
...
def download_ngrok():
    if not os.path.exists("ngrok.py"):
        res = requests.get("https://gitee.com/lstcml/qinglongscripts/raw/master/nwct/ngrok.py")
...
def get_server():
    try:
        res = requests.get("https://gitee.com/lstcml/qinglongscripts/raw/master/nwct/server.fd").text
